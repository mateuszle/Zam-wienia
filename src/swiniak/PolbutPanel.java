...
public class PolbutPanel {
	...
	public static JPanel Polbuty2 = new JPanel();
	
	
	
	public static String[] TabModelPolbuta=new String[50];
	public static String[] TabModelPolbuta2=new String[50];
	public static String[] TabKolorPolbuta=new String[50];
	public static String[] TabMaterialPolbuta=new String[50];
	public static String[] TabMaterialPodszewkiPolbuta=new String[50];
	public static int[] TabParyPolbuta=new int[50];
	...
	public PolbutPanel(){
		Polbuty.setBackground(SystemColor.text);
		Polbuty2.setBackground(SystemColor.text);

		if (Okienko.iloscPolbutow < 24) {
			if (Okienko.iloscBotkow != 0||Okienko.iloscSandalow!=0) {
				...
				btnDalej2.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						Polbuty2.setVisible(false);
						BotekPanel.Botki.setVisible(true);
						}else{
							SandalPanel bp = new SandalPanel();
							Polbuty.setVisible(false);
							Polbuty2.setVisible(false);
		...
		if (Okienko.iloscPolbutow < 24) {
			...
			Polbuty.add(btnNewButton2);

			btnNewButton2.addActionListener(new ActionListener() {

				public void actionPerformed(ActionEvent e) {

					if (Okienko.iloscPolbutow < 23) {
						Okienko.iloscPolbutow++;
						Okienko.iloscZamowien++;
						PolbutPanel b = new PolbutPanel(Okienko.iloscPolbutow - 1, Polbuty);
						Okienko.panel.setVisible(false);
						Polbuty.setVisible(true);
					} else
						;
			...
			btnNewButton3.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					PolbutPanel b4 = new PolbutPanel(true, Polbuty);
					Okienko.panel.setVisible(false);
					Polbuty.setVisible(true);
				}
			});
			...
			Polbuty2.add(btnNewButton2);

			btnNewButton2.addActionListener(new ActionListener() {

				public void actionPerformed(ActionEvent e) {

					if (Okienko.iloscPolbutow < 46) {
						Okienko.iloscPolbutow++;
						Okienko.iloscZamowien++;
						PolbutPanel b = new PolbutPanel(Okienko.iloscPolbutow - 1, Polbuty2);
						Okienko.panel.setVisible(false);
						Polbuty2.setVisible(true);
					} else
						;
			...
			btnNewButton3.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					PolbutPanel b4 = new PolbutPanel(true, Polbuty2);
					Okienko.panel.setVisible(false);
					Polbuty2.setVisible(true);
				}
			});
		...
		if (Okienko.iloscPolbutow < 24) {
			...
			btnNewButton.addActionListener(new ActionListener() { // PRZYCISK
				...
				public void actionPerformed(ActionEvent e) {
					...
					;
					JOptionPane.showMessageDialog(Polbuty,
		...
		if (Okienko.iloscPolbutow > 23) {
			...
			Polbuty.add(btnNewButton4);

			btnNewButton4.addActionListener(new ActionListener() {

				public void actionPerformed(ActionEvent e) {
					JLabel lblBotki = new JLabel("PÓŁBUTY");
					lblBotki.setHorizontalAlignment(SwingConstants.CENTER);
					lblBotki.setFont(new Font("Times New Roman", Font.BOLD, 38));
					lblBotki.setBounds(340, 0, 186, 55);
					Polbuty2.add(lblBotki);

					y = 69 + ((Okienko.iloscPolbutow - 23) * 25);

					Polbuty.setVisible(false);
					Polbuty2.setLayout(null);

					Okienko.frmZamwienia.getContentPane().add(Polbuty2, "name_6316592025561");
					Polbuty2.setVisible(true);
					...
					if (Okienko.iloscBotkow != 0||Okienko.iloscSandalow!=0) {
						...
						btnNewButton.addActionListener(new ActionListener() { // PRZYCISK
							...
							public void actionPerformed(ActionEvent e) {
								...
								;
								JOptionPane.showMessageDialog(Polbuty2,
			...
			JLabel lblPolbuty = new JLabel("PÓŁBUTY");
			lblPolbuty.setHorizontalAlignment(SwingConstants.CENTER);
			lblPolbuty.setFont(new Font("Times New Roman", Font.BOLD, 38));
			lblPolbuty.setBounds(340, 0, 186, 55);
			...
			if (Okienko.iloscPolbutow > 23) {
				for (; i < 23; i++, y += 25) {
					...
					wypiszDane(i, y, Polbuty);

				}
				for (int i = 23, y = 69; i < Okienko.iloscPolbutow; i++, y += 25) {
					wypiszDane(i, y, Polbuty2);
				}
			} else {
				for (; k < Okienko.iloscPolbutow; k++, y += 25) {

					wypiszDane(k, y, Polbuty);
				}
			}
	...
	// kostruktor dodowania
		@SuppressWarnings({ "rawtypes", "unchecked" })
		public PolbutPanel(int i, JPanel Botki) {

			// wypiszDane(i,255,Botki);
			sztuka = Okienko.iloscPolbutow;
			...
			materialCombo[i].setModel(
					new DefaultComboBoxModel(new String[] { "Skora", "Welur", "Tekstyl/текстиль", "Skora+Welur" }));
			...
			materialPoszewki[i].setModel(new DefaultComboBoxModel(new String[] { "Skora", "Filc", "Misiek" }));
	 ...
	 iloscPar[i].addActionListener(new ActionListener() {
		...
		//kostruktor od usuwania
		public PolbutPanel(boolean init, JPanel Botki) {
			...
			int pom;
			if (Okienko.iloscPolbutow < 24) {
				pom = 69 + (25 * Okienko.iloscPolbutow);
			} else {
				pom = 69 + ((Okienko.iloscPolbutow - 23) * 25);
			}
			i = Okienko.iloscPolbutow - 1;

			for (; i < Okienko.iloscPolbutow; i++, pom -= 25) {

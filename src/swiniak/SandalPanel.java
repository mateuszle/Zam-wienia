...
public class SandalPanel {
	...
	public static JPanel Sandaly = new JPanel();
	public static JPanel Sandaly2 = new JPanel();

	public static String[] TabModelSandala = new String[50];
	public static String[] TabModelSandala2 = new String[50];
	public static String[] TabkolorSandala = new String[50];
	public static String[] TabMaterialSandala = new String[50];
	public static String[] TabMaterialPodszewkiSandala = new String[50];
	public static int[] TabParySandala = new int[50];
	...
	public SandalPanel() {
		Sandaly.setBackground(SystemColor.text);
		Sandaly2.setBackground(SystemColor.text);

		
		if (Okienko.iloscSandalow < 24) {
			if (Okienko.iloscBotkow != 0) {
				...
				btnDalej2.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						Sandaly.setVisible(false);
						Sandaly2.setVisible(false);
						BotekPanel.Botki.setVisible(true);

					}
				});

				Sandaly.add(btnDalej2);
			}
		}
		...
		if (Okienko.iloscSandalow < 24) {
			...
			Sandaly.add(btnNewButton2);

			btnNewButton2.addActionListener(new ActionListener() {

				public void actionPerformed(ActionEvent e) {

					if (Okienko.iloscSandalow < 23) {
						Okienko.iloscSandalow++;
						Okienko.iloscZamowien++;
						SandalPanel b = new SandalPanel(Okienko.iloscSandalow - 1, Sandaly);
						Okienko.panel.setVisible(false);
						Sandaly.setVisible(true);
					} else
						;
			...
			btnNewButton3.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					SandalPanel b4 = new SandalPanel(true, Sandaly);
					Okienko.panel.setVisible(false);
					Sandaly.setVisible(true);
				}
			});
			...
			Sandaly2.add(btnNewButton2);

			btnNewButton2.addActionListener(new ActionListener() {

				public void actionPerformed(ActionEvent e) {

					if (Okienko.iloscSandalow < 46) {
						Okienko.iloscSandalow++;
						Okienko.iloscZamowien++;
						SandalPanel b = new SandalPanel(Okienko.iloscSandalow - 1, Sandaly2);
						Okienko.panel.setVisible(false);
						Sandaly2.setVisible(true);
					} else
						;
			...
			btnNewButton3.addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					SandalPanel b4 = new SandalPanel(true, Sandaly2);
					Okienko.panel.setVisible(false);
					Sandaly2.setVisible(true);
				}
			});
		...
		if (Okienko.iloscSandalow < 24) {
			...
			btnNewButton.addActionListener(new ActionListener() { // PRZYCISK
				...
				public void actionPerformed(ActionEvent e) {
					...
					;
					JOptionPane.showMessageDialog(Sandaly,
		...
		if (Okienko.iloscSandalow > 23) {
			...
			Sandaly.add(btnNewButton4);

			btnNewButton4.addActionListener(new ActionListener() {

				public void actionPerformed(ActionEvent e) {
					JLabel lblBotki = new JLabel("SANDAŁY");
					lblBotki.setHorizontalAlignment(SwingConstants.CENTER);
					lblBotki.setFont(new Font("Times New Roman", Font.BOLD, 38));
					lblBotki.setBounds(340, 14, 186, 30);
					Sandaly2.add(lblBotki);

					y = 69 + ((Okienko.iloscSandalow - 23) * 25);

					Sandaly.setVisible(false);
					Sandaly2.setLayout(null);

					Okienko.frmZamwienia.getContentPane().add(Sandaly2, "name_6316592025561");
					Sandaly2.setVisible(true);
					...
					if (Okienko.iloscBotkow != 0) {
						...
						btnNewButton.addActionListener(new ActionListener() { // PRZYCISK
							...
							public void actionPerformed(ActionEvent e) {
								...
								;
								JOptionPane.showMessageDialog(Sandaly2,
		...
		Okienko.frmZamwienia.add(Sandaly);
		// Okienko.frmZamwienia.getContentPane().add(Sandaly,
		// "name_6316592025561");
		Sandaly.setLayout(null);
		delete();
		for (int i = 0; i < 50; i++) {

			TabModelSandala[i] = "null";
		}
		for (int i = 0; i < 50; i++) {
			TabModelSandala2[i] = "null";
		}

		for (int i = 0; i < 50; i++) {
			TabkolorSandala[i] = "czarny";
		}
		for (int i = 0; i < 50; i++) {
			TabMaterialSandala[i] = "Tekstyl/текстиль";
		}
		for (int i = 0; i < 50; i++) {
			TabMaterialPodszewkiSandala[i] = "Tekstyl/текстиль";
		}
		for (int i = 0; i < 50; i++) {
			TabParySandala[i] = 8;
		}

		JLabel lblSandaly = new JLabel("SANDAŁY");
		lblSandaly.setHorizontalAlignment(SwingConstants.CENTER);
		lblSandaly.setFont(new Font("Times New Roman", Font.BOLD, 38));
		lblSandaly.setBounds(340, 14, 186, 30);
		Sandaly.add(lblSandaly);
		...
		if (Okienko.iloscSandalow > 23) {
			for (; i < 23; i++, y += 25) {
				...
				wypiszDane(i, y, Sandaly);

			}
			for (int i = 23, y = 69; i < Okienko.iloscSandalow; i++, y += 25) {
				wypiszDane(i, y, Sandaly2);
			}
		} else {
			for (; k < Okienko.iloscSandalow; k++, y += 25) {

				wypiszDane(k, y, Sandaly);
			}
		}

		for (int i = 0; i < Okienko.iloscSandalow; i++) {
			...
			model2[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int i = 0; i < Okienko.iloscSandalow; i++) {
						...
						SandalPanel.TabModelSandala[i] = str;
					}
			...
			model3[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int i = 0; i < Okienko.iloscSandalow; i++) {
						...
						SandalPanel.TabModelSandala2[i] = str2;
					}
			...
			materialCombo[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int i = 0; i < Okienko.iloscSandalow; i++) {
						...
						SandalPanel.TabMaterialSandala[i] = str;
			...
			materialPoszewki[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int i = 0; i < Okienko.iloscSandalow; i++) {
						...
						SandalPanel.TabMaterialSandala[i] = str2;
					}
			...
			iloscPar[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int i = 0; i < Okienko.iloscSandalow; i++) {
						...
						SandalPanel.TabParySandala[i] = pary;
					}
			...
			kolor[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					for (int i = 0; i < Okienko.iloscSandalow; i++) {
						...
						SandalPanel.TabkolorSandala[i] = str2;
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	public SandalPanel(int i, JPanel Botki) {

		// wypiszDane(i,255,Botki);
		sztuka = Okienko.iloscSandalow;
...
//kostruktor od usuwania
	public SandalPanel(boolean init, JPanel Botki) {
		...
		int pom;
		if (Okienko.iloscSandalow < 24) {
			pom = 69 + (25 * Okienko.iloscSandalow);
		} else {
			pom = 69 + ((Okienko.iloscSandalow - 23) * 25);
		}
		i = Okienko.iloscSandalow - 1;

		for (; i < Okienko.iloscSandalow; i++, pom -= 25) {

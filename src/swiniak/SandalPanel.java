...
public class SandalPanel {
	...
	public String kolorSandala="czarny";
	public String material="Tworzywo";
	public String materialPodszewki="Tworzywo";
	
	
	public static String[] TabModelSandala=new String[Okienko.iloscSandalow];
	public static String[] TabModelSandala2=new String[Okienko.iloscSandalow];
	public static String[] TabkolorSandala=new String[Okienko.iloscSandalow];
	public static String[] TabMaterialSandala=new String[Okienko.iloscSandalow];
	public static String[] TabMaterialPodszewkiSandala=new String[Okienko.iloscSandalow];
	public static int[] TabParySandala=new int[Okienko.iloscSandalow];
	
	JComboBox[] model2 = new JComboBox[Okienko.iloscSandalow];
	JComboBox[] model3 = new JComboBox[Okienko.iloscSandalow];
	JComboBox[] materialCombo = new JComboBox[Okienko.iloscSandalow];
	JComboBox[] materialPoszewki=new JComboBox[Okienko.iloscSandalow];
	JComboBox[] iloscPar = new JComboBox[Okienko.iloscSandalow];
	JComboBox[] kolor=new JComboBox[Okienko.iloscSandalow];
      ...
      if(Okienko.iloscBotkow==0){
       ...
       if(Okienko.iloscBotkow!=0){
		...
		Sandaly.add(btnDalej2);
			...
			Okienko.frmZamwienia.getContentPane().add(Sandaly, "name_6316592025561");
			...
			for(int i=0;i<Okienko.iloscSandalow;i++){
				TabMaterialSandala[i]="Tworzywo";
			}
			for(int i=0;i<Okienko.iloscSandalow;i++){
				TabMaterialPodszewkiSandala[i]="Tworzywo";
			}
			for(int i=0;i<Okienko.iloscSandalow;i++){
				TabParySandala[i]=8;
			}
			...
			for(;i<Okienko.iloscSandalow;i++,y+=25){
				...
				Sandaly.add(lblNewLabel_2);
				
				JLabel lblSandaly = new JLabel("SANDAŁY");
				lblSandaly.setHorizontalAlignment(SwingConstants.CENTER);
				lblSandaly.setFont(new Font("Times New Roman", Font.BOLD, 17));
				lblSandaly.setBounds(400, 17, 186, 20);
				...
				Sandaly.add(lblNewLabel_3);
				
				
				materialCombo[i] = new JComboBox();
				materialCombo[i].setBounds(500, y, 74, 20);
				materialCombo[i].setModel(new DefaultComboBoxModel(new String[] {"Tworzywo\t","Skora", "Welur", "Skora+Welur"}));
				Sandaly.add(materialCombo[i]);
				...
				Sandaly.add(lblMateriaPodszewki);
				
				 materialPoszewki[i]=new JComboBox();
				 materialPoszewki[i].setBounds(710, y, 93, 20);
				 materialPoszewki[i].setModel(new DefaultComboBoxModel(new String[] {"Tworzywo\t", "Skora"}));
				 Sandaly.add(materialPoszewki[i]);
				...
				Sandaly.add(lblMateriaPodeszwy);
			...
			for(int i=0;i<Okienko.iloscSandalow;i++){
				//String str3;
				System.out.println("ilsoc polbutow: "+Okienko.iloscSandalow);

...
public class KozakPanel {
	...
	public String kolorKozaka="czarny";
	public String material="welur";
	public String materialPodszewki="mis";
	
	
	public static String[] TabModelKozaka=new String[Okienko.iloscKozakow];
	public static String[] TabModelKozaka2=new String[Okienko.iloscKozakow];
	public static String[] TabKolorKozaka=new String[Okienko.iloscKozakow];
	public static String[] TabMaterialKozaka=new String[Okienko.iloscKozakow];
	public static String[] TabMaterialPodszewkiKozaka=new String[Okienko.iloscKozakow];
	public static int[] TabParyKozaka=new int[Okienko.iloscKozakow];
	
	JComboBox[] model2 = new JComboBox[Okienko.iloscKozakow];
	JComboBox[] model3 = new JComboBox[Okienko.iloscKozakow];
	JComboBox[] materialCombo = new JComboBox[Okienko.iloscKozakow];
	JComboBox[] materialPoszewki=new JComboBox[Okienko.iloscKozakow];
	JComboBox[] iloscPar = new JComboBox[Okienko.iloscKozakow];
	JComboBox[] kolor=new JComboBox[Okienko.iloscKozakow];
	...
	public KozakPanel(){
		...
		btnDalej2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				System.out.println("dsadadsadsaxvxc");
		...
		Kozaki.add(btnDalej2);
			...
			Okienko.frmZamwienia.getContentPane().add(Kozaki, "name_6316592025561");
			...
			for(;i<Okienko.iloscKozakow;i++,y+=25){
				...
				Kozaki.add(lblNewLabel_2);
				
				JLabel lblKozaki = new JLabel("KOZAKI");
				lblKozaki.setHorizontalAlignment(SwingConstants.CENTER);
				lblKozaki.setFont(new Font("Times New Roman", Font.BOLD, 17));
				lblKozaki.setBounds(400, 17, 186, 20);
				...
				Kozaki.add(lblMateriaPodszewki);
				
				 materialPoszewki[i]=new JComboBox();
				 materialPoszewki[i].setBounds(710, y, 93, 20);
				 materialPoszewki[i].setModel(new DefaultComboBoxModel(new String[] {"Misiek\t","Filc","Euro", "Skora"}));
				 Kozaki.add(materialPoszewki[i]);
				...
				model3[i].addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						...
						for(int i=0;i<Okienko.iloscKozakow;i++){
							...
							System.out.println("dupa dupa:"+ model2[i].getSelectedItem()+"|"+ model3[i].getSelectedItem());
